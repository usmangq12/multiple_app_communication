...
const ProfileDetailV2 = () => {
  const profileDetail = useSelector((state) => state.auth.userDetailV2);
  console.log("ProfileDetial",profileDetail);
  return (
...
export default ProfileDetailV2;
